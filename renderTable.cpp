...
void initTableAttendance(sf::Font & font, vector <AttendanceGraphic> & A, vector<AttendanceList> attend, ArrayOfCourse course, string courseID) {
	...
	for (int i = 0; i < At.size(); i++) {
		...
		if (At[i].getWeek1() == "" )ag.w[0].setString("");
			else ag.w[0].setString(At[i].getWeek1());
		if (At[i].getWeek2() == "")ag.w[1].setString("");
			else ag.w[1].setString(At[i].getWeek2());
		if (At[i].getWeek3() == "")ag.w[2].setString("");
			else ag.w[2].setString(At[i].getWeek3());
		if (At[i].getWeek4() == "")ag.w[3].setString("");
			else ag.w[3].setString(At[i].getWeek4());
		if (At[i].getWeek5() == "")ag.w[4].setString("");
			else ag.w[4].setString(At[i].getWeek5());
		posY = posY + 30;
		updateText(ag.no, font, sf::Color::White, 408, posY, 15);
		updateText(ag.stID, font, sf::Color::White, 440, posY, 15);
		updateText(ag.w[0], font, sf::Color::White, 570, posY, 15);
